...
@else
    <div class="w-11/12 mx-auto">
        <div class="alert alert-info">
            ...
            <p class="mt-1 text-base">Que diriez-vous de publier <a class="link" href="{{ route('post.create') }}">votre premier post</a> ou de commencer à
                <a class="link" href="{{ route('discover') }}">suivre des personnes</a>?</p>
        </div>
    </div>
@endif
